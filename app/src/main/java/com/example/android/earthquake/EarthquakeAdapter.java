...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView primayLocationView = convertView.findViewById(R.id.primary_location);
        primayLocationView.setText(primaryLocation);

        TextView locationView = convertView.findViewById(R.id.location_offset);
